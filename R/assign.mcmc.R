assign.mcmc <- function(Y, Bg, X, Delta_prior_p, iter=2000, adaptive_B=TRUE, adaptive_S=TRUE, mixture_beta=TRUE, sigma_sZero = 0.001, sigma_sNonZero = .001, p_beta = 0.01, sigma_bZero = 0.01, sigma_bNonZero = 1, alpha_tau = 1, beta_tau = 0.01, Bg_zeroPrior=TRUE, S_zeroPrior=TRUE, ECM = FALSE)
{  
